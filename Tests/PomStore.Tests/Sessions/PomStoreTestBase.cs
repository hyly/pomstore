...
namespace PomStore.Tests.Sessions
{
    public abstract class PomStoreTestBase : AbpIntegratedTestBase
    {
        protected PomStoreTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<PomStoreApplicationModule>();
            modules.Add<PomStoreDataModule>();
        }

        public void UsingDbContext(Action<PomStoreDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<PomStoreDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<PomStoreDbContext, T> func)
        {
            T result;
